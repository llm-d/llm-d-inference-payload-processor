...
ax_scatter, ax_median, ax_inflight, ax_ttft_stat = axes
...
for ax, title in [
    (ax_scatter,   "effectiveTTFT vs real TTFT (scatter)"),
    (ax_median,    f"effectiveTTFT vs real TTFT (median/{BIN_SEC}s bins)"),
    (ax_inflight,  "Inflight requests"),
    (ax_ttft_stat, "P10Low and P50"),
]:
    ax.set_ylabel("TTFT (s)" if ax != ax_inflight else "Inflight")
